...
const NewPasswordPage = () => {
  ...
  useEffect(() => {
    ...
    // The PASSWORD_RECOVERY event confirms a valid recovery session.
    ...
    // Handle cases where the token is invalid/expired and the event never fires.
  ...
  const handleUpdatePassword = async (e: React.FormEvent) => {
    ...
    if (updateError) {
      ...
      await supabase.auth.signOut(); // Log out for security
      setStatus('SUCCESS');
    }
        ...
        case 'SUCCESS':
            return (
                <div className="reset-password-container text-center">
                    ...
                    <p className="text-base text-gray-400 mb-8">Votre mot de passe a été modifié avec succès. Vous pouvez désormais vous connecter avec vos nouvelles informations.</p>
        ...
        case 'READY':
            return (
                 <div className="reset-password-container">
                    ...
                    <p className="text-base text-gray-400 mb-8">Veuillez saisir votre nouveau mot de passe pour sécuriser votre compte.</p>

        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-[#121926] to-[#1E2A38] flex items-center justify-center p-4">
                <div className="reset-password-container">
                    ...
                    <p className="text-base text-gray-400 mb-6">Si nous trouvons un compte éligible associé à cette adresse, nous enverrons un courriel à cette adresse contenant des instructions supplémentaires pour récupérer votre mot de passe.</p>
                    <button 
                        onClick={() => {
                            if (resendCooldown === 0) {
                                handlePasswordReset();
